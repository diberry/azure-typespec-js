 ...
 */
export function parseHttpDate(httpDate) {
 ...
 */
export function formatHttpDate(instant) {
 ...
 */
export function durationTotalSeconds(duration) {
    if (duration.years !== 0 ||
        duration.months !== 0 ||
        duration.weeks !== 0 ||
        duration.days !== 0) {
 ...
 * @returns the total number of seconds in the duration
 */
export function durationTotalSecondsBigInt(duration) {
    if (duration.years !== 0 ||
        duration.months !== 0 ||
        duration.weeks !== 0 ||
        duration.days !== 0) {
