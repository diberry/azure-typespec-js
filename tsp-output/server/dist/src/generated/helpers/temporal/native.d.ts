 ...
 */
export declare function parseHttpDate(httpDate: string): any;
/**
 ...
 */
export declare function formatHttpDate(instant: any): string;
/**
 ...
 */
export declare function durationTotalSeconds(duration: any): number;
/**
 ...
 * @returns the total number of seconds in the duration
 */
export declare function durationTotalSecondsBigInt(duration: any): bigint;
