...
export function createWidgetServiceRouter(widgets, options = {}) {
    ...
    const dispatch = createPolicyChain("WidgetServiceRouterDispatch", options.policies ?? [], async function (ctx, request, response) {
