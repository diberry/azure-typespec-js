...
export async function widgets_create(
  ...
  const __createRequestBody_14 = (await new Promise(
    function parseCreateRequestBody(resolve, reject) {
  ...
  try {
    __result_11 = await __operations_12.create(
      __ctx_10,
      __createRequestBody_14.id,
      __createRequestBody_14.weight,
      __createRequestBody_14.color,
    );
  } catch (e) {
    if (__isHttpResponder_0(e)) {
